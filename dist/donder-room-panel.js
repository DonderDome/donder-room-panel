    ...
    `}renderThermostat(t,e=!1){const i=this.hass.states[t.entity],o=e?"multi":"";return console.log("thermostat",t,i),O`
      <div class=${`donder-widget ${o}`}>
        ...
        <div class='summary-temp'>
          <div class='summary-temp-internal'>${t.internal_temp}</div>
          <div class='summary-temp-external'>${t.external_temp}</div>
        </div>
      </div>
    `}render(){var t;if(this.config.show_warning)return this._showWarning("warning message");if(this.config.show_error)return this._showError("error message");const e=this.hass.states["donder_env.global"].attributes;null===(t=this.hass.states["donder_scenes.global"])||void 0===t||t.attributes;const{rooms:i}=e,o=this.config.room_id,n=i.filter((t=>t.id===o))[0];return console.log("room",n),O`
      <ha-card
      ...
      >
        <div class='donder-widget-wrapper'>
          ${n.climate.map((t=>this.renderThermostat(t,n.climate.map.length>1)))}
        </div>
      </ha-card>
    `}}t([Y({attribute:!1})],St.prototype,"hass",void 0),t([G()],St.prototype,"config",void 0),customElements.define("donder-room-panel",St);export{St as BoilerplateCard};
