        ...
        <div class='summary-group-scenes'>
          ${o.map((t=>H`
              <div
                ...
                class="scene"
                .actionHandler=${Et({hasHold:_t(this.config.hold_action)})}
              >${i[t].name}</div>
            `))}
